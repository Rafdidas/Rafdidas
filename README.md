...
사용성과 유지보수성을 함께 고려하는 UI 퍼블리셔입니다.
이커머스와 B2B 업무 시스템에서 6년 이상 UI를 구축·운영했고,
반복되는 UI를 공통 컴포넌트와 디자인 시스템 기준으로 정리하는 일을 합니다.

**🔗 Portfolio: https://about-me-iota-blond.vercel.app/**
